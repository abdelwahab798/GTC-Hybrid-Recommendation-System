...
artifacts = joblib.load(r"C:\Users\nice\Desktop\projects\GTC recomomdation system\models\svd_full.pkl")
model = artifacts["model"]
df_stats = artifacts["df_stats"] 
indices = np.load(r"C:\Users\nice\Desktop\projects\GTC recomomdation system\metrics\indices.npy")
product_ids = np.load(r"C:\Users\nice\Desktop\projects\GTC recomomdation system\metrics\proudict_id.npy", allow_pickle=True).tolist()
df = pd.read_csv(r"C:\Users\nice\Desktop\projects\GTC recomomdation system\data\final_data.csv")
